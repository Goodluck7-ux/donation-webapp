        ...
        <main className="min-h-screen bg-base grid lg:grid-cols-[1.05fr_0.95fr] overflow-hidden">
            ...
            <section className="hidden lg:flex relative overflow-hidden bg-brand p-10 xl:p-14">
                ...
                <div className="relative z-10 w-full flex flex-col justify-between">
                    ...
                    <motion.div initial="hidden" animate="visible" variants={containerVariants} className="max-w-xl">
                        ...
                        >
                            ...
                            <span className="italic text-focus-ring">tomorrow.</span>
                        </motion.h1>

                        <motion.p variants={itemVariants} className="mt-6 max-w-lg text-base leading-7 text-white/65">
                            Follow the causes you care about, see your contributions at work, and stay connected to the impact you're helping create.
                        </motion.p>

                        <motion.div variants={itemVariants} className="mt-8 grid grid-cols-2 gap-3 max-w-md">
                            {['Verified campaigns', 'Transparent giving', 'Impact updates', 'Secure payments'].map((item) => (
                ...
                <motion.div initial="hidden" animate="visible" variants={containerVariants} className="w-full max-w-md">
                    ...
                    <motion.div variants={itemVariants}>
                        ...
                        <p className="mt-4 text-sm sm:text-base leading-6 text-text-secondary">
                            Sign in to manage your giving and stay connected with the causes you support.
                        </p>
                    </motion.div>

                    <motion.form variants={containerVariants} onSubmit={handleSubmit} className="mt-9 space-y-5">
                        ...
                        <motion.div variants={itemVariants} className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <Link href="/forgot-password" className="text-xs font-medium text-accent hover:text-text-primary transition-colors">
                                    Forgot password?
                                </Link>
                            </div>
                    ...
                    <motion.div variants={itemVariants} className="mt-6 flex items-center justify-center gap-2 text-xs text-text-muted">
                        <ShieldCheck size={14} />
