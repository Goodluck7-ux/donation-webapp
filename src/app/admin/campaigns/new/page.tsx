...
export default function NewCampaignPage() {
    ...
    return (
        <div className="p-6 sm:p-10 max-w-2xl mx-auto space-y-8">
            <div>
                <h1 className="font-display text-2xl sm:text-3xl text-neutral-900">New campaign</h1>
                <p className="text-neutral-500 mt-1 text-sm sm:text-base">Create a new fundraising campaign.</p>
            </div>
