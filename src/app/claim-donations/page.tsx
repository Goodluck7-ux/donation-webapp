...
function ClaimDonationsContent() {
    ...
    return (
        <div>
            ...
            <section className="max-w-lg mx-auto px-4 sm:px-6 pt-20 pb-24 text-center space-y-6">
                {isLoading && (
                    <p className="text-neutral-500">Confirming…</p>
                )}
                ...
                {data && (
                    <>
                        ...
                        <h1 className="font-display text-3xl text-[#173B2B]">
                            {data.claimedCount} donation
                            {data.claimedCount !== 1 ? 's' : ''} added to your
                            account
                        </h1>

                        <Link
                            href="/dashboard"
                            className="inline-block rounded-lg bg-[#1B4332] text-white px-6 py-3 font-medium hover:bg-[#143526]"
                        >
                            View your dashboard
                        </Link>
                    </>
